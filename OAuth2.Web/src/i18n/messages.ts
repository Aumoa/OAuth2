  ...
  ko: {
    app: {
      ...
      applicationManagement: {
        ...
        allowedScopesDescription: '이 클라이언트가 요청할 수 있는 사용자 정보 범위를 선택합니다.',
  ...
  en: {
    app: {
      ...
      applicationManagement: {
        ...
        allowedScopesDescription: 'Choose the user information scopes this client may request.',
  ...
  ja: {
    app: {
      ...
      applicationManagement: {
        ...
        allowedScopesDescription: 'このクライアントが要求できるユーザー情報の範囲を選択します。',
        saveChanges: '変更を保存',
        saved: '変更を保存しました。',
        dangerZone: 'Danger Zone',
