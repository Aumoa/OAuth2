  ...
  ko: {
    app: {
      ...
      applicationManagement: {
        ...
        deleteDialogDescription: '{clientId} 클라이언트와 관련 설정 및 권한을 영구 삭제합니다.',
        deleteConfirmationLabel: '클라이언트 ID 확인',
        deleteConfirmationHint: '계속하려면 {clientId}를 정확히 입력하세요.',
  ...
  en: {
    app: {
      ...
      applicationManagement: {
        ...
        deleteDialogDescription: 'Permanently delete the {clientId} client and its related settings and grants.',
        deleteConfirmationLabel: 'Confirm client ID',
        deleteConfirmationHint: 'Enter {clientId} exactly to continue.',
  ...
  ja: {
    app: {
      ...
      applicationManagement: {
        ...
        deleteDialogDescription: '{clientId}クライアントと関連する設定および権限を完全に削除します。',
        deleteConfirmationLabel: 'クライアントIDの確認',
        deleteConfirmationHint: '続行するには{clientId}を正確に入力してください。',
